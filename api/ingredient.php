...
class IngredientApi extends Api {
	 ...
	 */
	public static function recipeIngredients(int $recipe, mysqli $db) {
	 ...
	 */
	protected static function GET_recipe(array $params) {
	 ...
	 * @param array $params First value is recipe ID
	 */
	protected static function PUT_recipe(array $params) {
		if($recipe = trim(array_shift($params)))
			if(is_numeric($recipe))
